    ...
    public partial class firstMig : DbMigration
    {
        public override void Up()
        {
            ...
            CreateTable(
                ...
                .ForeignKey("dbo.Carrinhoes", t => t.Carrinho_Id)
                .ForeignKey("dbo.Encomendas", t => t.Encomendas_Id)
                .Index(t => t.Produto_Id)
                .Index(t => t.Carrinho_Id)
                .Index(t => t.Encomendas_Id);
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.ProdQuants", "Encomendas_Id", "dbo.Encomendas");
            DropForeignKey("dbo.ProdQuants", "Carrinho_Id", "dbo.Carrinhoes");
            DropForeignKey("dbo.ProdQuants", "Produto_Id", "dbo.Produtoes");
            ...
            DropIndex("dbo.ProdQuants", new[] { "Encomendas_Id" });
            DropIndex("dbo.ProdQuants", new[] { "Carrinho_Id" });
            DropIndex("dbo.ProdQuants", new[] { "Produto_Id" });
